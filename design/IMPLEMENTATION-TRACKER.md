...
| Phase 50 Codex 迁移全面收口 | ◐ 7/8 | T233-T239 已验证 |
...
| P0 | T240 | 全量验收与收口 | While Phase 50 收口, when 全部门禁执行, the repository shall 提供新鲜通过证据 | ◐ sync/metadata/Ruff/mypy/1815 tests/双宿主 smoke 已通过；coverage 84.51% < 90% |
...
| T240 | 全量 1815 passed / 1 skipped；coverage 84.51%（未过 90%）；Claude/Codex archive smoke pass，product install not_run |
