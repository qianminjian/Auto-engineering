...
- T527 已闭合 prepared journal 恢复漂移；2528/1 与静态检查通过。T526 Codex 功能终态通过但成本失败，L4/发布阻断。
## 最近演进
| 日期 | 变更 |
|---|---|
...
| 2026-08-22 | T525-T527 关闭 Action 正文重复与 journal 漂移；实测证明固定长会话仍产生百万级重放 |
## 待解决问题
- T528 待审批：是否以 Action-scoped fresh session 取代 D13 固定长会话；未批准前不以点状压缩冒充根治。
