...
| P0 | T474-T524 | 深审计权威、宿主身份、恢复边界、成本伸缩与锚点事实化 | While active Action 已有 thread/journal 事实, when 宿主跨会话/Build 恢复、误传旧路径、审计小项目或未来根目录尚未物化, the product shall 自动重绑/复用当前事实、按规模合并审计上下文，且只对已见证锚点的消失 fail-closed | ✅ T519/T522/T523 已验证；T524 以 `ProjectAnchorsWitnessed` 事件和 append-only baseline 闭合误报，2521/1、Ruff、mypy 通过；L3/L4 仍归 T467-T469 |
