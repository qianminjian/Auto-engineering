...
| P0 | T474-T526 | 深审计权威、宿主恢复、成本伸缩与紧凑控制面 | While active Action 跨会话恢复或产品宿主连续 Tick, when Core 输出下一动作, the product shall 保持 Canonical Action 完整，但只向宿主会话输出 digest-bound compact envelope，并以双宿主成本门禁阻止上下文放大版本发布 | ◐ T519-T525 已验证；T525 以 SHA-bound Coordinator Prompt 与 compact stdout 闭合内联重复，2527/1、Ruff、mypy、双宿主发布资产通过；T526 待同 Build L3 成本复验 |
